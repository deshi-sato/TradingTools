# scripts/check_minute_coverage.py 仕様書
...
## 主要関数・クラス
- ticker_candidates(ticker: str) -> None: 説明なし
- load_watchlist(path: Path) -> pd.DataFrame: 説明なし
- get_cov_for_ticker(con, ticker: str, date_str: str) -> None: 説明なし
- main() -> None: 説明なし
