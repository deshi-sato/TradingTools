# scripts/plot_eval_buy_sell.py 仕様書
...
## 主要関数・クラス
- cumprod_from_pct(series_pct: pd.Series) -> pd.Series: NaNは0として無視し、(1+r)の累積を返す（始値=1）。
- line_plot(x, y, title: str, y_label: str, out_png: Path) -> None: 説明なし
- main() -> None: 説明なし
